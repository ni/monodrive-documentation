...
- Set the file to save the data to (`.oxdr` for OpenDrive and `.json` for geoJson)
- Select the appropriate file format from the `Format` field
- Select the appropriate coordinates system 

...
class ScenarioVehicle(object):
    ...
    def plan_target_lane(waypoint_sensor, vehicle_state=None):
        if vehicle_state is not None:
            return ScenarioVehicle.check_scenario_for_target_lane(vehicle_state)
        else:
